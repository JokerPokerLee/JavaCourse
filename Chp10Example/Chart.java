...
class ChartComponent extends JComponent
{
   ...
   public void paintComponent(Graphics g)
   {
      ...
      Color c[]={Color.BLACK,Color.BLUE,Color.CYAN,Color.GREEN,Color.MAGENTA,Color.orange,Color.pink,Color.RED,Color.yellow};
      int x=0,y=0;
      ...
      for(int i=0;i<values.length;i++){
      	values[i]=values[i]*300/maxValue;
      	g2.setPaint(c[i]);
        g2.fillOval(x,y,(int)values[i],(int)values[i]);
        x=(int)(x+values[i]);
      }
